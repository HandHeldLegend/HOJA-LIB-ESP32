...
typedef enum
{
    BATTERY_CHARGER_PLUGGED     = 0,
    BATTERY_CHARGER_DISCONNECT  = 1,
    BATTERY_CHARGING_FAST       = 2,
    BATTERY_CHARGING_TRICKLE    = 3,
    BATTERY_CHARGING_COMPLETE   = 4,
    BATTERY_NO_COMMUNICATION    = 5,
    BATTERY_LEVEL_CHANGED       = 6,
    BATTERY_NOT_CHARGING        = 7,
